...
if '%1'=='' g++ -s -std=c++11 -Isrc -Isrc/win32 -DTRAFFICSIM_WIN32 -oTrafficSimulator src\*.cpp src\win32\*.cpp %EX% -lopengl32 -lglu32 -lcomctl32 -mwindows
...
if '%1'=='make' mingw32-make -f makefile-win32
